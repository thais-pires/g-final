...
import { MarcaDialogComponent } from 'src/app/marcaDialog/marca.component';
...
export class ListagemComponent implements OnInit {
  ...
  // Método para abrir o MatDialog ao clicar no nome da marca
  openMarcaDialog(marca: any): void {
  ...
  displayedColumns: string[] = ['id', 'nome', 'marca', 'dataCompra', 'duracaoGarantiaMeses', 'dataFimGarantia', 'options'];
  ...
  constructor(private produtoService: ProdutoService, private marcaService: MarcaService, private cdr: ChangeDetectorRef, private router: Router, private dialog: MatDialog) { }
  ...
  abrirDetalhesMarca(marca: Marca): void {
    this.dialog.open(MarcaDialogComponent, {
      data: { marca },
    });
  }
